...
def KNN_Movie_Recommender(test_point, k):
    try:
        ...
        st.error(f"Error in KNN Movie Recommender: {e}")
        return []
...
def run():
    try:
        ...
        if cat_op == category[0]:
            ...
            st.markdown('<h4 style="text-align: left; color: #d73b5c;">* Fetching a Movie Posters will take time."</h4>', unsafe_allow_html=True)
